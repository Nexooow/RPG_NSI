...
class Accueil (Menu):
    ...
    def draw_main(self):
        ...
        text_render_centered(self.jeu.fond, "Game Name", "extrabold", color=(
            255, 255, 255), pos=(1000/2, 175), size=128)
        ...
        text_render_centered(self.jeu.fond, "Charger une partie", "regular",
                             color=(245, 205, 0, 185) if len(
                                 self.saves) > 0 else (255-100, 215-100, 0, 140),
                             pos=(1000/2, 400),
    ...
    def draw_sauvegardes(self):
        ...
        text_render_centered(self.jeu.fond, "Sauvegardes", "bold", color=(
            255, 255, 255), pos=(1000/2, 175), size=86)

        for index, save in enumerate(self.saves):
            text_render_centered(self.jeu.fond, f"{save['id']}", "regular",
                color=(245, 205, 0, 185),
    ...
    def draw(self):
        ...
        for particle in self.particules:
            pygame.draw.circle(self.jeu.fond, (245, 205, 0,
